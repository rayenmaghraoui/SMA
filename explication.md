...
| **SQL Agent** | DuckDB | Base analytique in-memory — 3 CSV comme tables SQL |
...
├── sql_agent/
│   ├── db.py                   ← DuckDB in-memory : charge les 3 CSV comme tables
